...
from Dianshang.settings import EMAIL_HOST_USER
...
def send_captcha_email(email):
    ...
    subject = '找回密码'  # 主题
    code = uuid.uuid4().hex
    message = email_name + "您好，您正在华为商城进行找回密码，请点击此链接进行重置密码: http://39.100.70.135:8000/api/user/auth/resetpassword/?token=" + code + "\n（请在24小时内完成验证。该链接24小时以内有效）"
